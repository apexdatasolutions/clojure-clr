...
let simpleEmptySeqTests = 
    testList "simpleEmptySeq" [
        
        testCase "simpleEmptySeq implements ISeq" <| fun _ ->
        ...
        testCase "simpleEmptySeq implements IPersistentCollection" <| fun _ ->
        ...
        testCase "simpleEmptySeq implements Seqable" <| fun _ ->
...
let consTests = 
    testList "simpleCons" [
        ...
        testCase "simpleCons implements ISeq" <| fun _ ->
        ...
        testCase "simpleCons implements IPersistentCollection" <| fun _ ->
            let c =  SimpleCons.makeConsSeq 4 
        ...
        testCase "simpleCons implements Seqable" <| fun _ ->
             let c =  SimpleCons.makeConsSeq 4 
...
[<Tests>]
let simpleMapTests = 
    testList "SimpleMap tests" [
    
        testCase "SimpleMap.empty" <| fun _ ->
        ...
        testCase "simpleMap.count" <| fun _ ->
        ...
        testCase "simpleMap.valAt(_)" <| fun _ ->
            let sm5 = SimpleMap.makeSimpleMap 5
        ...
        testCase "simpleMap.valAt(_,_)" <| fun _ ->
            let sm5 = SimpleMap.makeSimpleMap 5
        ...
        testCase "simpleMap.equiv" <| fun _ ->
            ...
            Expect.isFalse ((sm5a:>IPersistentCollection).equiv(sm5c))  "Should not be equiv to one with missing value"
            Expect.isFalse ((sm5a:>IPersistentCollection).equiv(sm4))  "Should not be equiv to one with missing value"
            Expect.isFalse ((sm4:>IPersistentCollection).equiv(sm5a))  "Should not be equiv to one with missing value"
            Expect.isTrue ((sm5a:>IPersistentCollection).equiv(sm5d))  "Should be equiv to one with keys/vals in different order"
            Expect.isFalse ((sm5a:>IPersistentCollection).equiv(sm5e)) "Should not be equiv to one with a differnt value"            
