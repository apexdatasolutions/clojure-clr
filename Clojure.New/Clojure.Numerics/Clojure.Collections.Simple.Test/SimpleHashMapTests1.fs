...
let basicSimpleHashMapCreateTests =
    ftestList "Basic SimpleHashMap create tests" [
...
let basicSimpleHashMapAssocTests =
    ftestList "Basic SimpleHashMap Assoc tests" [
...
let basicSimpleHashMapPersistentCollectionTests =
    ftestList "Basic SimpleHashMap PersistentCollection tests" [
...
let basicSimpleHashMapPersistentMapTests =
    ftestList "Basic SimpleHashMap tests" [
