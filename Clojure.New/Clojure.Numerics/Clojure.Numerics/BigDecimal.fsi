namespace Clojure.Numerics
  ...
  type Context =
    ...
    with
      ...
      static member
        Create : precision:uint32 * roundingMode:RoundingMode -> Context
  ...
  type BigDecimal =
    class
      ...
      private new : coeff:System.Numerics.BigInteger * exp:int * precision:uint ->
                      BigDecimal
      ...
      static member
        Create : coeff:System.Numerics.BigInteger * exp:int -> BigDecimal
      ...
      static member
        Create : v:char array * offset:int * len:int * c:Context -> BigDecimal
      ...
      static member
        CreateC : v:System.Numerics.BigInteger * c:Context -> BigDecimal
      ...
      static member
        DivRem : x:BigDecimal * y:BigDecimal * remainder:outref<BigDecimal> ->
                   BigDecimal
      static member
        DivRem : x:BigDecimal * y:BigDecimal * c:Context *
                 remainder:outref<BigDecimal> -> BigDecimal
      static member Divide : x:BigDecimal * y:BigDecimal -> BigDecimal
      static member
        Divide : x:BigDecimal * y:BigDecimal * c:Context -> BigDecimal
      ...
      static member
        Multiply : x:BigDecimal * y:BigDecimal * c:Context -> BigDecimal
      ...
      static member
        Parse : s:System.ReadOnlySpan<char> * c:Context -> BigDecimal
      ...
      static member
        Parse : v:char array * offset:int * len:int * c:Context -> BigDecimal
      ...
      static member
        Quantize : lhs:BigDecimal * rhs:BigDecimal * mode:RoundingMode ->
                     BigDecimal
      /// Return an equivalent-valued BigDecimal rescaled to the given exponent. 
      static member
        Rescale : lhs:BigDecimal * newExponent:int * mode:RoundingMode ->
                    BigDecimal
      ...
      static member
        Subtract : x:BigDecimal * y:BigDecimal * c:Context -> BigDecimal
      ...
      static member
        TryParse : s:System.ReadOnlySpan<char> * value:outref<BigDecimal> ->
                     bool
      ...
      static member
        TryParse : s:System.String * value:outref<BigDecimal> -> bool
      ...
      static member
        TryParse : a:char array * c:Context * value:outref<BigDecimal> -> bool
      ...
      static member
        TryParse : s:System.ReadOnlySpan<char> * c:Context *
                   value:outref<BigDecimal> -> bool
      ...
      static member
        TryParse : s:System.String * c:Context * value:outref<BigDecimal> ->
                     bool
      ...
      static member
        TryParse : a:char array * offset:int * len:int *
                   value:outref<BigDecimal> -> bool
      ...
      static member
        TryParse : a:char array * offset:int * len:int * c:Context *
                   value:outref<BigDecimal> -> bool
      ...
      member
        DivRem : y:BigDecimal * c:Context * remainder:outref<BigDecimal> ->
                   BigDecimal
